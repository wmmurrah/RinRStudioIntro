...
factor.df <- star[ ,c('gender', 'ethnicity', 'school1', 'degreek')]
...
tableNominal(factor.df, group=star$tx, print.pval='chi2',
             cap='Descriptive Statistics for Qualitative Variables')

@
\clearpage
<<descriptiveNumeric, results='asis'>>=
tableContinuous(numeric.df, group=star$tx, print.pval='anova',
